...
/// Zhiyuan: 1st ModulePass - "DataStructures"
class DataStructures : public ModulePass {
/// Zhiyuan: Function -> DSGraph
  ...
  /// Were ??are??(zhiyuan: typo?) DSGraphs stolen by another pass?
  bool DSGraphsStolen;
...
/// but we ??use?? (?zhiyuan: typo) take a completed call graph and inline all indirect callees into
